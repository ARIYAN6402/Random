...
def o():
    ...
    if opt == '2':
        ...
        return None
    if opt == '3':
        os.system('xdg-open https://youtube.com/@XhoterGaming?si=FIQDhf2lK2hyrwXx')
        return None
    if opt == '4':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100034501160287&mibextid=ZbWKwL')
         return None
...
def i():
    ...
    os.system("clear")
    print(logo)
    passx = int(input("[*] No Password : "))
    HamiiID = []
    print("")
    for bilal in range(passx):
        pww = input("[*] No Password : ")
        HamiiID.append(pww)
